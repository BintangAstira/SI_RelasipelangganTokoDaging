...
<div class="card">
    ...
    <div class="card-body card-block">
        <form method="post" action="{{ route('pegawai.store') }}">
            @csrf 
            @method('post') 
            <div class="form-group"><label for="nf-Nama_Pegawai" class=" form-control-label">Nama Pegawai</label><input type="text" id="nf-Nama_Pegawai" name="Nama_Pegawai" placeholder="Nama" class="form-control"><span class="help-block">Please enter your Name</span></div>
