...
<div class="card">
    ...
    <div class="card-body card-block">
        <form method="post" action="{{ route('penukaranpoin.store') }}">
            @csrf 
            @method('post') 
            <div class="form-group"><label for="nf-id_penukaranpoin" class=" form-control-label">Id Penukaran Poin</label><input type="text" id="nf-id_penukaranpoin" name="id_penukaranpoin" placeholder="id_penukaranpoin.." class="form-control"><span class="help-block">Please enter your ID Penukaran Poin</span></div>
            <div class="form-group"><label for="nf-id_poin" class=" form-control-label">Id Poin</label><input type="text" id="nf-id_poin" name="id_poin" placeholder="id_poin.." class="form-control"><span class="help-block">Please enter your ID Poin</span></div>
            ...
            <div class="form-group"><label for="nf-Hadiah" class=" form-control-label">Hadiah</label><input type="text" id="Hadiah" name="Hadiah" placeholder="Hadiah.." class="form-control"><span class="help-block">Please enter your Hadiah</span></div>
